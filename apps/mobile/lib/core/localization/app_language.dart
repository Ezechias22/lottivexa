...
class AppLanguage {
  ...
  static const _fr=<String,String>{
    ...
    'Lajan tikè ak rapò':'Devise des tickets et rapports','Chwazi USD pou dola ameriken.':'Choisissez USD pour les dollars américains.','Lajan tikè a sove.':'Devise des tickets enregistrée.',
