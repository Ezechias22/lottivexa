...
class EscPosEncoder {
  ...
  Uint8List ticket(Map<String, dynamic> ticket) {
    ...
    _line(out, ticket['businessName']?.toString() ?? 'LOTTIVEXA');
    out.add([0x1b, 0x45, 0]);
  ...
  Uint8List testPage(String name) => Uint8List.fromList([0x1b, 0x40, ...utf8.encode('LOTTIVEXA\nPrinter: $name\nTEST OK\n\n\n'), 0x1d, 0x56, 0]);
