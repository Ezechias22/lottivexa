...
export const messages = {
  ht: {
    ...
    'dashboard.today':'Vant jodi a','dashboard.payouts':'Peman gayan jodi a','dashboard.net':'Balans nèt jodi a','dashboard.tickets':'Tikè jodi a','dashboard.branches':'Biwo','dashboard.merchants':'Machann','dashboard.alerts':'Alèt ki poko li','dashboard.recent':'Dènye tikè yo','report.byGame':'Vant pa lotri','report.byBranch':'Vant pa biwo','report.net':'Vant nèt apre peman','report.noDraws':'Pa gen vant nan tiraj pou peryòd sa a.','report.session':'Lè tiraj','report.branch':'Biwo','report.fromToday':'Peryòd la gen ladan jodi a Ayiti.',
  ...
  fr: {
    ...
    'dashboard.today':'Ventes du jour','dashboard.payouts':'Gains payés aujourd’hui','dashboard.net':'Solde net du jour','dashboard.tickets':'Tickets du jour','dashboard.branches':'Succursales','dashboard.merchants':'Vendeurs','dashboard.alerts':'Alertes non lues','dashboard.recent':'Tickets récents','report.byGame':'Ventes par loterie','report.byBranch':'Ventes par succursale','report.net':'Ventes nettes après paiements','report.noDraws':'Aucune vente par tirage pour cette période.','report.session':'Séance','report.branch':'Succursale','report.fromToday':'La période utilise la date locale d’Haïti.',
...
export function LanguageProvider({children}: {children: ReactNode}) {
  ...
  useEffect(() => {
    ...
    const change=(event:Event)=>{const selected=(event as CustomEvent<Language>).detail;if(selected==='ht'||selected==='fr')setLanguage(selected)};
    window.addEventListener('lottivexa-language-change',change);return()=>window.removeEventListener('lottivexa-language-change',change);
  }, []);
  useEffect(() => {
