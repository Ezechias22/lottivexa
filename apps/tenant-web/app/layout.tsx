...
export default function Layout({children}:{children:ReactNode}){return <html lang="ht"><body><PwaRegister/><LanguageProvider><LanguageSwitcher/>{children}</LanguageProvider></body></html>}
