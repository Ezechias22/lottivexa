...
export class MerchantsController {
  ...
  @Get("me") me(@CurrentUser() u: Principal) {
    return this.service.me(u);
  }
  @Get("me/dashboard") dashboard(@CurrentUser() u: Principal) {
    return this.service.dashboard(u);
  }
  @Get() @RequirePermissions("merchants.view") list(
    @CurrentUser() u: Principal,
  ) {
    return this.service.list(u);
  }
  @Post() @RequirePermissions("merchants.create") create(
    @CurrentUser() u: Principal,
    @Body() dto: CreateMerchantDto,
  ) {
    return this.service.create(u, dto);
  }
  @Patch(":id") @RequirePermissions("merchants.edit") update(
    @CurrentUser() u: Principal,
    @Param("id") id: string,
  ...
  @Patch(":id/disable") @RequirePermissions("merchants.disable") disable(
    @CurrentUser() u: Principal,
    @Param("id") id: string,
  ) {
    return this.service.disable(u, id);
  }
  @Patch(":id/reactivate") @RequirePermissions("merchants.disable") reactivate(
    @CurrentUser() u: Principal,
    @Param("id") id: string,
  ) {
    return this.service.reactivate(u, id);
  }
}
