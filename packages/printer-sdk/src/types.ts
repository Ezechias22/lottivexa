...
export interface TicketPrintData{businessName:string;ticketNumber:string;branch:string;game:string;draw:string;lines:{betType?:string;selection:string;stake:string;potentialWin:string}[];amount:string;potentialWin:string;createdAt:string;barcode:string;qrCode:string}
